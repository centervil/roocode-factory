...
- [x] **Phase 2: Refactoring**
    ...
    - [x] Ensure the "Architectural Separation" principle is generic.
- [x] **Phase 3: Verification**
    - [x] Verify that the document still provides clear, actionable instructions.
    - [x] Check for any accidental breakage of link or reference logic.
- [x] **Phase 4: Completion**
    - [x] Update `project_state.md` (via skill or manual update).
